...
<head>
    ...
    <script language="javascript">
        $(function () {
            $.ajax({
                url: "fspQuestion/selCourse",  // 请求URL
                type: "GET",
                data: {}, //请求的参数
            ...
            $('#courseType').change(function () {
                ...
                $.get("fspQuestion/selTechCategory", {"id": $('#courseType').val()}, function (resp) {
                    console.dirxml(resp);
                    $.each(resp, function (i, item) { // foreach item, item={id:101,name:"海淀"}
        ...
        <div class="container">
            <div class="row clearfix" style="padding-top: 20px">
                ...
                <div class="col-md-10 column">
                    <form action="fspQuestion/search">
                    ...
                    <div class="row">
                        ...
                        <c:forEach var="fspQuestion" items="${page}" varStatus="stat">
                            <div class="col-lg-12" id="div_${fspQuestion.id}">
                                <div class="ibox float-e-margins">

                                    <div class="ibox-title">
                                        <h5>${fspQuestion.question}</h5>
                                    ...
                                    <div class="ibox-content" style="display: block;">
                                        <div><p>${fspQuestion.stdAnswer}</p></div>
                                        <div style="text-align: right">
                                            <a id="toUpdateBtn" questionId="${fspQuestion.id}" href="#" class="btn btn-info btn-sm"
                                               data-toggle="modal" data-target="#myModal" data-backdrop="static" >
                                                ...
                                                <%--<a id="toUpdateBtn" id="${fspQuestion.id}"  href="fspQuestionUpdate.jsp?qid=${fspQuestion.id}" class="btn btn-info btn-sm"--%>
                                                   <%--data-toggle="modal" data-target="#myModal" data-backdrop="static">--%>
                                                    <%--<span class="glyphicon glyphicon-refresh"></span> 更新--%>
                                                <%--</a>--%>
                                            <a href="javascript:void(0);" class="btn btn-danger btn-sm" id="${fspQuestion.id}" id="deleteBtn"
