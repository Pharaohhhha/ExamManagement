            ...
            <div class="container">
                <div class="row clearfix">
                    ...
                    <div class="col-md-10 column">
                        <form  method="post"  action="question/insertjudgeQuestion">
                            ...
                            <ul class="nav nav-tabs nav-justified">
                                ...
                                <li class="active"><a href="views/question/index3.jsp">新增判断题</a></li>
                            ...
                            <div class="form-group">
                                <label id="name3">判断题题干</label>
                                <textarea class="form-control"rows="6" name="question" ></textarea><br>
                                <div class="text-center"><label id="name4">正确答案</label>
                                    <input type="radio" name="correct"  value="对" aria-label="..." >对&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" name="correct" value="错" aria-label="...">错</div>
                            </div>
                            <br><br>
