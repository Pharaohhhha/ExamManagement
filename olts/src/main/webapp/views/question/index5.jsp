                    ...
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">${logUser.user_name}</strong>
                             </span> <span class="text-muted text-xs block">老师
            ...
            <div class="container">
                <div class="row clearfix">
                    ...
                    <div class="col-md-10 column">
                        <form  method="post"  action="question/insertFspQuestion">
                            ...
                            <ul class="nav nav-tabs nav-justified">
                                ...
                                <li class="active"><a href="views/question/index5.jsp">新增编程题</a></li>
                            </ul><br><br><br>
                            ...
                            <div class="form-group">
                                <label id="name3">编程题题干</label>
                                <textarea class="form-control"rows="8"  name="question" ></textarea><br>
                            </div>
                            <div class="form-group">
                                <label id="name4">编程题答案</label>
                                <textarea class="form-control"rows="8"  name="stdAnswer"></textarea><br>
                            </div>
                            <br><br>
