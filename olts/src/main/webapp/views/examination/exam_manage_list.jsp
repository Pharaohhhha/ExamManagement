    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
           ...
           <!-- 这里放你们JSP的DIV -->
            ...
            <h2 align="center">
                试卷 &nbsp;&nbsp;<small>(试卷编号:${examinations.examNo})</small>
            </h2>
            ...
            <div class="showPuestion">
                ...
                <div class="showSingle">
                    <c:forEach var="smd" items="${examinations.smdQuestions}"
                               varStatus="num" begin="0">
                            ...
                            <div class="input-group m-b" style="margin-top: 10px">
									<span class="input-group-btn">
										<button type="button" class="btn btn-primary" value="">
											正确答案<!-- <img alt="" src="images/common/answer.png"> -->
										</button>
									</span> <input name="answer" type="text" class="form-control"
                                                   style="width: 50px" value="${smd.correct }">
                            </div>
                            <div>
                                <a href="admin/updateExam?questionType=1&examNo=${examinations.examNo}&questionIds=${smd.id }"><button
                                        type="button" id="delete" class="btn btn-danger">从该试卷删除此题</button></a>
                                <!-- <button class="btn btn-primary" style="margin-left: 30px"
                            onclick="addSelectSim();">从该试卷删除单选题</button>			 -->
                        ...
                        <c:if test="${smd.questionType eq 2 }">
                            ...
                            <div class="input-group m-b" style="margin-top: 10px">
									<span class="input-group-btn">
										...
										正确答案
                                            <!-- <img alt="" src="images/common/answer.png"> -->
										</button>
									</span> <input name="answer" type="text" class="form-control"
                                                   style="width: 50px" value="${smd.correct }">
                            </div>
                            <div>
                                <a href="admin/updateExam?questionType=2&examNo=${examinations.examNo}&questionIds=${smd.id }"><button
                                        type="button" id="delete" class="btn btn-danger">从该试卷删除此题</button></a>
                            </div>
                            <hr>
                        </c:if>
                ...
                <div class="showSingle">
                    <c:forEach var="smd" items="${examinations.smdQuestions}"
                        ...
                        <c:if test="${smd.questionType eq 3 }">
                            ...
                            <div>
                                <div>
                                    <a href="admin/updateExam?questionType=3&examNo=${examinations.examNo}&questionIds=${smd.id }"><button
                                            type="button" id="delete" class="btn btn-danger">从该试卷删除此题</button></a>
                                </div>
                            </div>
                            <hr>
                ...
                <form action="admin/insertFspAnswer" method="post">
                    ...
                    <div class="showSingle">
                        <c:forEach var="fsp" items="${examinations.fspQuestions}"
                                   varStatus="num1" begin="0">
                            <c:if test="${fsp.questionType eq 4 }">
                                <p>第${num1.index+1}题：${fsp.question}</p>
                                <!-- <p>参考答案：</p> -->
                                <textarea style="width: 100%; height: 100px" name="${fsp.id }" value=""></textarea>
                                <hr>
                                <div>
                                    <a href="admin/updateExam?questionType=4&examNo=${examinations.examNo}&questionIds=${fsp.id }"><button
                                            type="button" id="delete" class="btn btn-danger">从该试卷删除此题</button></a>
                                </div>
                            </c:if>
                        </c:forEach>
                    ...
                    <div class="showSingle">
                        <c:forEach var="fsp" items="${examinations.fspQuestions}"
                            ...
                            <c:if test="${fsp.questionType eq 5 }">
                                ...
                                <hr>
                                <div>
                                    <a href="admin/updateExam?questionType=5&examNo=${examinations.examNo}&questionIds=${fsp.id }"><button
                                            type="button" id="delete" class="btn btn-danger">从该试卷删除此题</button></a>
                                </div>
                            </c:if>
                        </c:forEach>
                    ...
                    <div class="showSingle">
                        <c:forEach var="fsp" items="${examinations.fspQuestions}"
                            ...
                            <c:if test="${fsp.questionType eq 6 }">
                                ...
                                <hr>
                                <div>
                                    <a href="admin/updateExam?questionType=6&examNo=${examinations.examNo}&questionIds=${fsp.id }"><button
                                            type="button" id="delete" class="btn btn-danger">从该试卷删除此题</button></a>
                                </div>
                            </c:if>
                        </c:forEach>
