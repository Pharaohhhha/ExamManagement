...
<head>
    ...
    <script type="text/javascript">
        ...
        function selectValidExamNo(){
            $.post("admin/selExamNo",function(data){
//	 			查看试卷之前把上一次显示的列表删除
        ...
        <div class="navbar-header">
           ...
           <!-- 这里放你们JSP的DIV -->
            <div style="width: 100%; height: 750px">
                ...
                <form action="admin/cheackGrade" method="post" style="margin:0 auto; width:400px">
                    试卷编号：<input type="text" name="examNo" id="examNo" value="GLTY14578980" >
                    <input type="button"  class="btn btn-primary" name="selExnoBtn" id="selExnoBtn" value="选择" onclick="selectValidExamNo()"><br>
                    <div id="showExnoDiv" >
                        <ul id="showExnoUl" style="list-style-type:none;padding-left:0;margin-top:15px;margin-bottom:0"></ul>
                    </div>
                    &nbsp&nbsp&nbsp&nbsp<input type="submit" value="查询" class="btn btn-primary">
