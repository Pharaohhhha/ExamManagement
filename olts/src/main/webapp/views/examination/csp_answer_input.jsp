...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            $.get("admin/selExamNo",function(data){
                var select =$("#exam_no");
        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="admin/showExamRadio" src="" class="cs-navi-tab"><img src="images/icons/ns_doc.gif"/>考试</a></li>
                        <c:if test="${true }">
           ...
           <!-- 这里放你们JSP的DIV -->
            <div style="width: 100%; height: 750px;">
                <div style="width:30%;margin-left:35%;text-align: center;">
                    <form action="admin/showStuFspAnswer" method="post">
                        <h2>试卷编号</h2>
                        <div class="input-group">
                            <select class="select2_demo_1 form-control" name="exam_no" id="exam_no">

                            </select>
                            <span class="input-group-btn">
										<input type="submit" class="btn btn-primary" name="selExnoBtn" id="selExnoBtn" value="选择" ">
									</span>
                        </div>
                        <div id="showExnoDiv" >
