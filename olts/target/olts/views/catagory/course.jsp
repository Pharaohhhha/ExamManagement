                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 column">
                                ...
                                <form action="courses/selectBySelective" method="post" align="center" name="myForm2">
                                    ...
                                    <tr>
                                        <td><input type="submit" value="查询" class="btn" style="background-color: #EE82EE;height: 27px;line-height: 5px;margin-right: 66px">
                                            <a href="courses/selectBySelective"></a></td>
                                    </tr>
                                </form>
                                <br>
                                <!-- 表头 -->
                                    ...
                                    <tr style="color: #008B00">
                                        <td colspan='3'>
                                            <c:if test="${not empty coursePage}">
                                                <ul class="pagination">
                                                    <li><a href="courses/selectAllCourse?pageNo=1">«</a></li>
                                                    <c:if test="${coursePage.pageNo gt 3}">
                                                        <li><a href="javascript:void(0)">....</a></li>
                                                    </c:if>
                                                    <c:if test="${coursePage.pageNo-2 ge 1}">
                                                        <li><a href="courses/selectAllCourse?pageNo=${coursePage.pageNo-2}">${coursePage.pageNo-2}</a></li>
                                                    </c:if>
                                                    <c:if test="${coursePage.pageNo-1 ge 1}">
                                                        <li><a href="courses/selectAllCourse?pageNo=${coursePage.pageNo-1}">${coursePage.pageNo-1}</a></li>
                                                    </c:if>
                                                    <li  class="active"><a href="courses/selectAllCourse?pageNo=${coursePage.pageNo}">${coursePage.pageNo}</a></li>
                                                    <c:if test="${coursePage.pageNo+1 le coursePage.totalPage}">
                                                        <li><a href="courses/selectAllCourse?pageNo=${coursePage.pageNo+1}">${coursePage.pageNo+1}</a></li>
                                                    </c:if>
                                                    <c:if test="${coursePage.pageNo+2 le coursePage.totalPage}">
                                                        <li><a href="courses/selectAllCourse?pageNo=${coursePage.pageNo+2}">${coursePage.pageNo+2}</a></li>
                                                    </c:if>
                                                    <c:if test="${coursePage.pageNo+2 lt coursePage.totalPage}">
                                                        <li><a href="javascript:void(0)">....</a></li>
                                                    </c:if>
                                                    <li><a href="courses/selectAllCourse?pageNo=${coursePage.totalPage}">»</a></li>
                                                </ul>
                                            </c:if>
                                        </td>
                                    </tr>
