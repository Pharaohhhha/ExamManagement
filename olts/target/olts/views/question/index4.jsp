                    ...
                    <div class="col-md-10 column">
                        <form  method="post"  action="question/insertFspQuestion">
                            ...
                            <ul class="nav nav-tabs nav-justified">
                                ...
                                <li class="active"><a href="views/question/index4.jsp">新增简答题</a></li>
                            ...
                            <div class="form-group">
                                <label id="name3">简答题题干</label>
                                <textarea class="form-control"rows="6"  name="question"></textarea><br>
                            </div>
                            <div class="form-group">
                                <label id="name4">标准答案</label>
                                <textarea class="form-control"rows="6" name="stdAnswer"></textarea><br>
                            </div>
                            <br><br>
