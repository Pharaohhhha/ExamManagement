        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="javascript:void(0);" src="views/question/shortAnswer_list.jsp" class="cs-navi-tab"><img src="images/icons/ns_doc.gif"/>客观题查询</a></li>
                        <li><a href="javascript:void(0);" src="views/question/program_list.jsp" class="cs-navi-tab"><img src="images/icons/ns_doc.gif"/>主观题查询</a></li>
                    </ul>
                </li>
                <li>
            ...
            <div class="row clearfix" style="padding-top: 20px">
                ...
                <div class="col-md-10 column">
                    ...
                    <div class="row">
                        ...
                        <c:forEach var="SmdQuestion" items="${page2}" varStatus="stat">
                            <div class="col-lg-12" id="div_${SmdQuestion.id}">
                                    ...
                                    <div class="ibox-content" style="display: block;">
                                        <div>
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    <td>A</td>
                                                    <td>${SmdQuestion.smdOption.optionA}</td>
                                                </tr>
                                                <tr>
                                                    <td>B</td>
                                                    <td>${SmdQuestion.smdOption.optionB}</td>
                                                </tr>
                                                <tr>
                                                    <td>C</td>
                                                    <td>${SmdQuestion.smdOption.optionC}</td>
                                                </tr>
                                                <tr>
                                                    <td>D</td>
                                                    <td>${SmdQuestion.smdOption.optionD}</td>
                                                </tr>
                                                <tr>
                                                    <td>正确</td>
                                                    <td>${SmdQuestion.correct}</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
        ...
        <div class="modal-content" id="myMdal-content">
            <form action="question/update">
                ...
                <div class="modal-body">
                    ...
                    标准答案：<input type="text" class="form-control" name="correct" >
                    题型：
                    <select name="questionType" style="width: 100px ;height: 35px;border-radius: 5px">
                        <option value=''>请选择题型</option>
                        <option value='1'>单选题</option>
