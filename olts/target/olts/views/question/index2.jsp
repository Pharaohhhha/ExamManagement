                    ...
                    <div class="col-md-10 column">
                        <form  method="post"  action="question/insertSmdQuestion">
                            ...
                            <ul class="nav nav-tabs nav-justified">
                                <li><a href="views/question/index1.jsp">新增单选题</a></li>
                                <li class="active"><a href="views/question/index2.jsp">新增多选题</a></li>
                                <li><a href="views/question/index3.jsp">新增判断题</a></li>
                                <li><a href="views/question/index6.jsp">新增填空题</a></li>
                                <li><a href="views/question/index4.jsp">新增简答题</a></li>
                                <li><a href="views/question/index5.jsp">新增编程题</a></li>
                            </ul><br><br><br>
                            <div class="form-group">
                                <label id="name3">多选题题干</label>
                                <textarea class="form-control"rows="6"  name="question"></textarea><br>
                                <div class="text-center"><button type="button" class="btn btn-success">复制格式代码</button></div>
                            </div>
                            ...
                            <div class="row">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" name="optionA" class="form-control" placeholder="请输入..." aria-describedby="sizing-addon1">
                                    <span class="input-group-addon">
                           <input type="checkbox" aria-label="..." name="correct" value="A">
                    </span>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" name="optionB" class="form-control" placeholder="请输入..." aria-describedby="sizing-addon1">
                                    <span class="input-group-addon">
                           <input type="checkbox" aria-label="..." name="correct" value="B">
                    </span>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text"  name="optionC" class="form-control" placeholder="请输入..." aria-describedby="sizing-addon1">
                                    <span class="input-group-addon">
                           <input type="checkbox" aria-label="..." name="correct" value="C">
                    </span>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" name="optionD" class="form-control" placeholder="请输入..." aria-describedby="sizing-addon1">
                                    <span class="input-group-addon">
                           <input type="checkbox" aria-label="..." name="correct" value="D">
                    </span>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="input-group input-group-lg">
                                    <span class="input-group-addon" id="sizing-addon5" style="background-color: #9B859D">E</span>
                                    <input type="text"  name="optionE" class="form-control" placeholder="请输入..." aria-describedby="sizing-addon1">
                                    <span class="input-group-addon">
                           <input type="checkbox" aria-label="..." name="correct" value="E">
                    </span>
                                </div>
                            </div><br><br>
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary">提交</button>&nbsp&nbsp&nbsp
